        ...
        Observable.create(
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ToastUtils.show(AccountActivity.this, R.string.clear_data_successful);
                    }
                });
    }
        ...
        AccountService.changeUserName(username)
                ...
                .subscribe(new Observer<BaseResponse>() {
                    ...
                    public void onError(Throwable e) {
                        ToastUtils.showNetworkError(AccountActivity.this);
                    ...
                    public void onNext(BaseResponse baseResponse) {
                        if (baseResponse.isOk()) {
                            ...
                            account.update();
                            ToastUtils.show(AccountActivity.this, R.string.change_user_name_successful);
                        } else {
                            mUserNameTv.setText(AccountService.getCurrent().getUserName());
                            ToastUtils.show(AccountActivity.this, R.string.change_user_name_failed);
                        }
                    }
                });
    }
    ...
    private void changePassword(String oldPassword, String newPassword) {
        AccountService.changePassword(oldPassword, newPassword)
                ...
                .subscribe(new Observer<BaseResponse>() {
                    ...
                    public void onNext(BaseResponse baseResponse) {
                        if (!baseResponse.isOk()) {
                            ToastUtils.show(AccountActivity.this, R.string.change_password_failed);
                        } else {
                            ToastUtils.show(AccountActivity.this, R.string.change_password_successful);
                        }
                    }
                });
    }
